...
#define SAMP_CAP_CH   (CH1)  /**< Possible values are CH1, CH2, CH3 and CH4 */
...
#define SCKEY_DETECTTHRESHOLD_DEFAULT                (69)  /**< Single channel key detection threshold (value from 1 to 127) */
#define SCKEY_ENDDETECTTHRESHOLD_DEFAULT             (69)  /**< Single channel key end detection threshold (value from 1 to 127) */
#define SCKEY_RECALIBRATIONTHRESHOLD_DEFAULT       (-22)  /**< Single channel key calibration threshold (value from -1 to -128) */

// Single-channel keys Acquisition values limits
#define SCKEY_MIN_ACQUISITION                       (8)  /**< Single channel key minimum acquisition value */
#define SCKEY_MAX_ACQUISITION                     (58888)  /**< Single channel key maximum acquisition value */
...
#define RECALIBRATION_INTEGRATOR_DEFAULT  (8)  /**< Calibration integrator (value from 1 to 255) */

// IIR Filter
#define ECS_TIME_STEP_DEFAULT             (28)  /**< IIR Filter Sampling frequency, multiple of 10ms */
#define ECS_TEMPO_DEFAULT                 (28)  /**< IIR Filter Delay after detection, multiple of 100ms */
#define ECS_IIR_KFAST_DEFAULT             (1)  /**< IIR Filter K factor for fast filtering */
#define ECS_IIR_KSLOW_DEFAULT             (1)  /**< IIR Filter K factor for slow filtering */
...
#define CLWHTA                             (8)  /**< Waiting time during capacitor charging: value from 0 to 50 (= 1.56µs @ 32MHz) */
// Capacitance Loading Waiting LOW Time Adjustment
#define CLWLTA                             (8)  /**< Waiting time during transfer phase: value from 0 to 50 (= 1.56µs @ 32MHz) */
